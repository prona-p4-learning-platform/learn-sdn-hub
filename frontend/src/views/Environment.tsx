        ...
        return (
            <>
                <Grid container spacing={0}>
                    <Grid item xs={6}>
                        <TabControl tabNames={[ "Assignment", "Terminals", "Topology" ]} handleRestart={handleConfirmationRestartDialogOpen} environmentStatus={this.state.environmentStatus}>
                            {/* First tab content "Assignment" */}
                            ...
                            <Grid container direction="row" justifyContent="flex-start" alignItems="center" spacing={1}>
                                ...
                                <button onClick={startContainerlab} className="">Containerlab starten</button>
                                <iframe title="containerlab-frame" id="containerlab-frame" src="http://localhost:3003" width={"100%"} height={"800px"}></iframe>
                            </Grid>
                        </TabControl>
                    </Grid>
                    <Grid item xs={6}>
