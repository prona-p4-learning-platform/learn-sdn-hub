...
console.log("Attempting to start Local VM Application for development purposes.")
const persister = new MemoryPersister();
serverCreator(api(persister, [new PlaintextAuthenticationProvider()], new LocalVMProvider()));
